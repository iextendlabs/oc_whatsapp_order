...
/* vqmod\vqcache\vq2-catalog_view_template_product_product.twig */
class __TwigTemplate_f3ee00130891931e592dbadf633dd0a81a5adbc5239e80998c48ab7a9c3d5e90 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (($context["module_whatsapp_button_status"] ?? null)) {
            echo "<a  type=\"button\" class=\"btn  btn-lg btn-block\" style=\"background-color:";
            echo ($context["whatsapp_button_color"] ?? null);
            echo "; color: #fff;\" href=\"https://wa.me/";
            echo ($context["whatsapp_number"] ?? null);
            echo "?text=";
            echo ($context["whatsapp_message"] ?? null);
            echo " URL: ";
            echo twig_urlencode_filter(twig_replace_filter(($context["share"] ?? null), ["&amp;" => "&"]));
            echo "\" target=\"_blank\"> ";
            echo ($context["whatsapp_button_text"] ?? null);
            echo "</a>";
        }
        // line 209
        echo "                </div>
...
";
    ...
    {
        return "vqmod\\vqcache\\vq2-catalog_view_template_product_product.twig";
    }
